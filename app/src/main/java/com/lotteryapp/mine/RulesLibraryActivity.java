...
import com.lotteryapp.runescape.IssueActivity;

import java.util.ArrayList;
import java.util.List;

public class RulesLibraryActivity extends Activity {
    private ImageView backBtn;
    private ListView rulesLv;
    private RulesCheckedAdapter adapter;
    private List<RulesListValue> list;

    private Button useRulesLibrary;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.mine_ruleslibrary);
        ...
        backBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(RulesLibraryActivity.this, MainActivity.class);
        ...
        adapter = new RulesCheckedAdapter(this,list,R.layout.mine_ruleslabrary_list_item);
        ...
        //使用规库发布
        useRulesLibrary = (Button) findViewById(R.id.use_rules_library);
        useRulesLibrary.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(RulesLibraryActivity.this, IssueActivity.class);
                startActivity(intent);
            }
        });
